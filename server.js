...
// These two keys are only needed if you plan on using the AWS SDK
    serverPublicKey = process.env.AWS_SERVER_PUBLIC_KEY,
    serverSecretKey = process.env.AWS_SERVER_SECRET_KEY,
...
app.listen(port, function() {
  console.log("S3 request-signing server started at port " + port);
});
